...
class Llama2Plugin(Generator):
    """
    Plugin for generating text using LLama model.
    """

    class Llama2PluginConfig(Config):
        api_key: str = Field(
            "",
        ...
        max_retries: int = Field(
            2, description="Maximum number of retries to make when generating."
        )
    ...
    def config_cls(cls) -> Type[Config]:
        return cls.Llama2PluginConfig

    config: Llama2PluginConfig
